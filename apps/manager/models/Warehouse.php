 ...
 */
class Warehouse extends ModelBase implements ModelInterface
{
  ...
  public function initialize()
  {
    ...
    $this->hasMany('id', ProductIn::class, 'warehouse_id', [
      'alias' => 'productin',
      'foreignKey' => [
    ...
    $this->hasMany('id', ProductQuantity::class, 'warehouse_id', [
