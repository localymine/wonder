...
class Acl extends Component
{
  ...
  private $privateResources = array(
    ...
    'clients'      => array('index', 'new', 'create', 'show', 'edit', 'save', 'delete'),
    'invoices'     => array('index', 'new', 'create', 'show', 'edit', 'save', 'delete'),
    'transports'   => array('index', 'new', 'create', 'show', 'edit', 'save', 'delete'),
  );
  ...
  public function __construct()
  {
    ...
    $this->filePath = SKR_ROOT.'/var/tmp/acl/manager.txt';
  }
