...
{% block content %}
  <section class="content-header">
    <h1>{{ l10n.__('Manage Types','type') }}</h1>
    <ol class="breadcrumb">
      <li>{{ link_to('manager/main/index', l10n._('<i class="fa fa-dashboard"></i> DashBoard')) }}</li>
      <li>{{ link_to('manager/types/index', l10n.__('Manage Types','type')) }}</li>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        {{ link_to('manager/types/new/',l10n._('<i class="fa fa-file"></i><span>New</span>'),'class':'btn btn-primary btn-sm xcenter') }}

      </div>
      <div class="box-body" data-csrftoken="{{ security.getToken() }}">

        {{ partial('partials/paginator/types') }}
