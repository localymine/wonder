...
{% block content %}
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      {{ form('manager/types/save','method':'post','class':'form-horizontal','role':'form') }}

      {#{{ hidden_field('user_id','value':type.user_id) }}#}

      {{ hidden_field('id','value':type.id) }}

      <div class="box-body">
        <div class="form-group">
          <label for="name" class="col-xs-12 col-sm-3 control-label">{{ l10n._('ID') }}</label>
          <div class="col-xs-12 col-sm-3">
            {{ text_field('name','class':'form-control','disabled':true,'value':type.id) }}
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            {{ text_field('name','class':'form-control','value':type.name) }}
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            {{ text_area('remarks','class':'form-control','rows':'3','value':type.remarks) }}
