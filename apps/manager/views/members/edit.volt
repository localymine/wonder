    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="form-group required">
          ...
          <div class="col-xs-12 col-sm-3">
            {{ select('type',type,'class':'form-control selectpicker show-tick','data-style':'btn-white','useEmpty':true,'emptyText':l10n._('Choose...'), 'emptyValue':'','value':client.type) }}
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-2">
            {{ text_field('postal','class':'form-control','value':client.postal) }}
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            {{ text_field('address','class':'form-control','value':client.address) }}
