  ...
  <div class="modal-dialog modal-lg chart-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">{{ l10n.__('Product in Stock', 'product') }} - <span class="product-name text-bold text-success"></span></h4>
      </div>
        ...
        <div class="bb-filter-abox form-horizontal row">
          <div class="form-group">
            ...
            <div class="col-sm-9 form-inline">
              <label for="formdate" class="control-label">{{ l10n._('From') }}</label>
              <input type="text" id="fromDate" class="form-control" />

              <label for="todate" class="control-label">{{ l10n._('To') }}</label>
