...
{% block content %}
  <section class="content-header">
    <h1>{{ l10n._('Manage Brands') }}</h1>
    <ol class="breadcrumb">
      <li>{{ link_to('manager/main/index', l10n._('<i class="fa fa-dashboard"></i> DashBoard')) }}</li>
      <li>{{ link_to('manager/brands/index', l10n._('Manage Brands')) }}</li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      {{ form('manager/brands/save','method':'post','class':'form-horizontal','role':'form') }}

      {#{{ hidden_field('user_id','value':brand.user_id) }}#}

      {{ hidden_field('id','value':brand.id) }}

      <div class="box-body">
        <div class="form-group">
          <label for="name" class="col-xs-12 col-sm-3 control-label">{{ l10n._('ID') }}</label>
          <div class="col-xs-12 col-sm-3">
            {{ text_field('name','class':'form-control','disabled':true,'value':brand.id) }}
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            {{ text_field('name','class':'form-control','value':brand.name) }}
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            {{ text_area('remarks','class':'form-control','rows':'3','value':brand.remarks) }}
      ...
      <div class="box-footer">
        <div class="action-area">
          ...
          {{ link_to('manager/brands/index',l10n._('Cancel'),'class':'btn btn-default') }}
