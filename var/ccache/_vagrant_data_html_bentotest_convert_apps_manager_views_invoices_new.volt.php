      ...
      <div class="box-body">
        ...
        <div class="form-group required">
          ...
          <div class="col-xs-12 col-sm-3">
            <?php echo $this->tag->select(array('deliver', $deliver, 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '', 'value' => 0)); ?>
