...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php echo $this->tag->form(array('manager/clients/create', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form')); ?>
      ...
      <div class="box-body">
        <div class="form-group required">
          <label for="country_id" class="col-xs-12 col-sm-3 control-label"><?php echo $this->l10n->_('Country'); ?></label>
          <div class="col-xs-12 col-sm-3">
            <?php echo $this->tag->select(array('country_id', $countries, 'using' => array('id', 'name'), 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '')); ?>
        ...
        <div class="form-group required">
          ...
          <div class="col-xs-12 col-sm-3">
            <?php echo $this->tag->select(array('type', $type, 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '')); ?>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            <?php echo $this->tag->textField(array('firstname', 'class' => 'form-control')); ?>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            <?php echo $this->tag->textField(array('lastname', 'class' => 'form-control')); ?>
