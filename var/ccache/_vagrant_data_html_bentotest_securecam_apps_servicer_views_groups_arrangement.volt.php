...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><?php echo $this->tag->linkTo(array('servicer/groups/index', $this->l10n->_('Manage Groups'))); ?></li>
              ...
              <div class="input-group input-group-sm input-group-fake group-header-pad">
                ...
                <span class="input-group-btn">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><?php echo $this->tag->linkTo(array('servicer/groups/show/' . $layer1->id, $this->l10n->_('<i class="fa fa-eye"></i> Show Layer'))); ?></li>
                    <li><?php echo $this->tag->linkTo(array('servicer/groups/new/' . $member->id . '/' . $layer1->id, $this->l10n->_('<i class="fa fa-file"></i> New Area'))); ?></li>
                  </ul>
                </span>
              </div>
<?php } else { ?>
              <?php echo $this->tag->linkTo(array('servicer/groups/new/' . $member->id . '/1', $this->l10n->_('New Root Group'), 'class' => 'btn btn-primary btn-md btn-block')); ?>

<?php } ?>
            </div>
            <div class="col-xs-12 col-sm-8">
<?php if (isset($layer2)) { ?>
<?php $this->partial('groups/arrangement-layer2', array('layer2' => $layer2, 'layer3' => $layer3)); ?>
<?php } ?>
            </div>
          </div>
        </div>
