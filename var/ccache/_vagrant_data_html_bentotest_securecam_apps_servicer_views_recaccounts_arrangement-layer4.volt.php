...
<?php if ($abox->group_id == $l3) { ?>
                      <div class="input-group input-group-sm input-group-fake group-header-pad">
                        <span class="form-control"><?php echo $abox->name; ?></span>
                        <span class="input-group-btn">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li><?php echo $this->tag->linkTo(array('servicer/recaccounts/showabox/' . $abox->id, $this->l10n->_('<i class="fa fa-eye"></i> Show Account'))); ?></li>
<?php if ($identity['role_id'] == 1) { ?>
                            <li><?php echo $this->tag->linkTo(array('servicer/recaccounts/edit/' . $l3, $this->l10n->_('<i class="fa fa-pencil"></i> Edit Account'))); ?></li>
<?php } ?>
                          </ul>
                        </span>
                      </div>
