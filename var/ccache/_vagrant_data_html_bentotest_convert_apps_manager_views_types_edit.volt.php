...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><?php echo $this->tag->linkTo(array('manager/types/index', $this->l10n->_('Manage Types'))); ?></li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php echo $this->tag->form(array('manager/types/save', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form')); ?>

      

      <?php echo $this->tag->hiddenField(array('id', 'value' => $type->id)); ?>

      <div class="box-body">
        <div class="form-group">
          <label for="name" class="col-xs-12 col-sm-3 control-label"><?php echo $this->l10n->_('ID'); ?></label>
          <div class="col-xs-12 col-sm-3">
            <?php echo $this->tag->textField(array('name', 'class' => 'form-control', 'disabled' => true, 'value' => $type->id)); ?>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            <?php echo $this->tag->textField(array('name', 'class' => 'form-control', 'value' => $type->name)); ?>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            <?php echo $this->tag->textArea(array('remarks', 'class' => 'form-control', 'rows' => '3', 'value' => $type->remarks)); ?>
      ...
      <div class="box-footer">
        <div class="action-area">
          ...
          <?php echo $this->tag->linkTo(array('manager/types/index', $this->l10n->_('Cancel'), 'class' => 'btn btn-default')); ?>
