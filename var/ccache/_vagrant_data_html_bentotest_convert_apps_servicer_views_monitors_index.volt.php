  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <?php echo $this->tag->linkTo(array('servicer/monitors/new', $this->l10n->_('<i class="fa fa-file"></i><span>New</span>'), 'class' => 'btn btn-primary btn-sm xcenter')); ?>

      </div>
      <div class="box-body" data-csrftoken="<?php echo $this->security->getToken(); ?>">

        <?php echo $this->partial('partials/paginator/monitors'); ?>

      </div>
    </div>

    <?php echo $this->partial('partials/filter/monitors'); ?>
  ...
  <script>
    $(function () {
      $.searchform({
        ...
        formEntry: ['root_id', 'area_id', 'group_id', 'name', 'hwaddr', 'status', 'firmver'],
