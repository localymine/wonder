                  ...
                  <div class="input-group input-group-sm input-group-fake group-header-pad">
                    ...
                    <span class="input-group-btn">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right">
                        <li><?php echo $this->tag->linkTo(array('servicer/viewaccounts/show/' . $l3->id, $this->l10n->_('<i class="fa fa-eye"></i> Show Account'))); ?></li>
                        <li><?php echo $this->tag->linkTo(array('servicer/viewaccounts/edit/' . $l3->id, $this->l10n->_('<i class="fa fa-pencil"></i> Edit Account'))); ?></li>
                      </ul>
                    </span>
                  </div>
<?php } ?>
