<a href="<?= $this->url->get('manager/main/index') ?>" class="logo"><span class="logo-mini"><b>SMC</b></span><span class="logo-lg"><b>SecureMC</b></span></a>
...
<?php if ($identity['role_id'] == 1 || $identity['role_id'] == 3) { ?>
    <?= $this->tag->linkTo(['servicer/main/index', '<i class="fa fa-wrench"></i>' . $this->l10n->_('Move to SMC Servicer site'), 'class' => 'movesvr']) ?>

<?php } ?>
  </li>
  <li class="user-footer"><?= $this->tag->linkTo(['manager/sessions/end', $this->l10n->_('Sign Out'), 'class' => 'btn btn-default btn-flat']) ?></li>
  </ul></li>
</ul>
</div>
</nav>
