        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><?php echo $this->l10n->__('Filter Recorders', 'Filter'); ?></h4>
            </div>
            <div class="modal-body">
              <div class="bb-filter-abox form-horizontal row">
                ...
                <div class="col-xs-7 col-sm-7">
                  <div class="form-group">
                    <label for="name" class="col-xs-12 col-sm-4 control-label"><?php echo $this->l10n->_('Recorder Name'); ?></label>
                    <div class="col-xs-12 col-sm-8">
                  ...
                  <div class="form-group">
                    <label for="status" class="col-xs-12 col-sm-4 control-label"><?php echo $this->l10n->_('Life-Or-Death'); ?></label>
                    <div class="col-xs-12 col-sm-8">
                    <?php echo $this->tag->selectStatic(array('status', $doa_label, 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '')); ?>
