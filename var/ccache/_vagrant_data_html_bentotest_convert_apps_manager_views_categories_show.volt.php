...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><?php echo $this->tag->linkTo(array('manager/categories/index', $this->l10n->_('Manage Brand'))); ?></li>
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row row-gutter-20">
          <div class="col-xs-12 col-sm-6">
            ...
            <td><?php echo $this->escaper->escapeHtml($category->id); ?></td>
            </tr>
            <tr>
          ...
          <div class="col-xs-12 col-sm-6">
            ...
            <tr>
              ...
              <td><?php if ($category->disabled == 1) { ?><?php echo $this->l10n->_('Disabled'); ?><?php } ?></td>
            </tr>
            <tr>
            <tr>
              <th><?php echo $this->l10n->_('Updated at'); ?></th>
              <td><?php echo date($this->l10n->_('Y-m-d H:i:s'), strtotime($category->updated)); ?></td>
            </tr>
            </table>
          </div>
        </div>
      ...
      <div class="box-footer">
        <div class="action-area">
          <?php echo $this->tag->linkTo(array('manager/categories/edit/' . $category->id, $this->l10n->_('<i class="fa fa-pencil"></i> Edit'), 'class' => 'btn btn-success pull-left')); ?>

          <?php echo $this->tag->linkTo(array('manager/categories/delete/' . $category->id, $this->l10n->_('<i class="fa fa-trash"></i> Delete'), 'class' => 'btn btn-danger pull-left')); ?>
