  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo $this->l10n->__('Filter Monitors', 'Filter'); ?></h4>
      </div>
      <div class="modal-body">
        <div class="bb-filter-abox form-horizontal row">
          ...
          <div class="col-xs-7 col-sm-7">
            <div class="form-group">
              <label for="name" class="col-xs-12 col-sm-4 control-label"><?php echo $this->l10n->__('Monitor Name', 'Monitor'); ?></label>
              <div class="col-xs-12 col-sm-8">
            ...
            <div class="form-group">
              <label for="status" class="col-xs-12 col-sm-4 control-label"><?php echo $this->l10n->_('Connection status'); ?></label>
              <div class="col-xs-12 col-sm-8">
            ...
            <div class="form-group">
              <label for="firmver" class="col-xs-12 col-sm-4 control-label"><?php echo $this->l10n->_('Firmware Version'); ?></label>
              <div class="col-xs-12 col-sm-8">
                <?php echo $this->tag->textField(array('firmver', 'class' => 'form-control', 'placeholder' => $this->l10n->__('Enter Firmware version', 'Filter'))); ?>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" filter-handler="reset"><i
              class="fa fa-times"></i> <?php echo $this->l10n->_('Discards filter'); ?></button>
        <button type="button" class="btn btn-primary" filter-handler="apply"><i
              class="fa fa-check"></i> <?php echo $this->l10n->_('Apply filter'); ?></button>
      </div>
    </div>
  </div>
</div>
