            ...
            <div class="modal-body">
              <div class="bb-filter-abox form-horizontal row">
                ...
                <div class="col-xs-7 col-sm-7">
                  <div class="form-group">
                    <label for="name" class="col-xs-12 col-sm-4 control-label"><?php echo $this->l10n->_('Related Agent'); ?></label>
                    <div class="col-xs-12 col-sm-8">
                  ...
                  <div class="form-group">
                    <label for="memtype" class="col-xs-12 col-sm-4 control-label"><?php echo $this->l10n->_('External Memory'); ?></label>
                    <div class="col-xs-12 col-sm-8">
                    <?php echo $this->tag->selectStatic(array('memtype', $memtype_label, 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '')); ?>
