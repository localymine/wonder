...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php echo $this->tag->form(array('servicer/monitors/create', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form')); ?>
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-4">
            <?php echo $this->tag->textField(array('firmver', 'class' => 'form-control')); ?>
