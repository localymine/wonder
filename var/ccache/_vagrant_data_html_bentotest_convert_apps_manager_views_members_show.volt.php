...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><?php echo $this->tag->linkTo(array('manager/members/index', $this->l10n->_('Manage Member'))); ?></li>
    ...
    <div class="box">
        ...
        <div class="row row-gutter-20">
          <div class="col-xs-12 col-sm-6">
            <table class="table table-bordered">
              ...
              <tr>
                <th><?php echo $this->l10n->_('Login'); ?></th>
                <td><?php echo $this->escaper->escapeHtml($member->login); ?></td>
              </tr>
              <tr>
                <th><?php echo $this->l10n->_('Password'); ?></th>
                <td><?php echo $this->escaper->escapeHtml($member->password); ?></td>
              </tr>
              </tbody>
            </table>
          </div>
          <div class="col-xs-12 col-sm-6">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td><?php echo nl2br($member->remarks); ?></td>
              </tr>
              <tr>
                <th><?php echo $this->l10n->_('Disabled'); ?></th>
                <td><?php if ($member->disabled == 1) { ?><?php echo $this->l10n->_('Disabled'); ?><?php } ?></td>
              </tr>
              <tr>
              <tr>
      ...
      <div class="box-footer">
        <div class="action-area">
          <?php echo $this->tag->linkTo(array('manager/members/edit/' . $member->id, $this->l10n->_('<i class="fa fa-pencil"></i> Edit'), 'class' => 'btn btn-success pull-left')); ?>

          <?php echo $this->tag->linkTo(array('manager/members/delete/' . $member->id, $this->l10n->_('<i class="fa fa-trash"></i> Delete'), 'class' => 'btn btn-danger pull-left')); ?>
