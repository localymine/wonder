...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><?php echo $this->l10n->_('Manage Outgoings'); ?></h1>
    <ol class="breadcrumb">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row row-gutter-20">
          <div class="col-xs-12 col-sm-6">
            ...
            <td><?php echo $this->escaper->escapeHtml($outgoing->id); ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><?php echo $this->escaper->escapeHtml($outgoing->type->name); ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><?php echo date('Y-m-d H:i', strtotime($outgoing->exec_date)); ?></td>
            </tr>
            </tbody>
            </table>
          </div>
          <div class="col-xs-12 col-sm-6">
            ...
            <tr>
              ...
              <td><?php echo nl2br($outgoing->remarks); ?></td>
            </tr>
            <tr>
              <th><?php echo $this->l10n->_('Disabled'); ?></th>
              <td><?php if ($outgoing->disabled == 1) { ?><?php echo $this->l10n->_('Disabled'); ?><?php } ?></td>
            </tr>
            <tr>
            <tr>
              <th><?php echo $this->l10n->_('Updated at'); ?></th>
              <td><?php echo date($this->l10n->_('Y-m-d H:i:s'), strtotime($outgoing->updated)); ?></td>
            </tr>
            </table>
          </div>
        </div>
      ...
      <div class="box-footer">
        <div class="action-area">
          <?php echo $this->tag->linkTo(array('manager/outgoing/edit/' . $outgoing->id, $this->l10n->_('<i class="fa fa-pencil"></i> Edit'), 'class' => 'btn btn-success pull-left')); ?>

          <?php echo $this->tag->linkTo(array('manager/outgoing/delete/' . $outgoing->id, $this->l10n->_('<i class="fa fa-trash"></i> Delete'), 'class' => 'btn btn-danger pull-left')); ?>
