...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><?php echo $this->l10n->_('Manage Incomes'); ?></h1>
    <ol class="breadcrumb">
      <li><?php echo $this->tag->linkTo(array('manager/main/index', $this->l10n->_('<i class="fa fa-dashboard"></i> DashBoard'))); ?></li>
      <li><?php echo $this->tag->linkTo(array('manager/incomes/index', $this->l10n->_('Manage Incomes'))); ?></li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php echo $this->tag->form(array('manager/incomes/save', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form')); ?>

      

      <?php echo $this->tag->hiddenField(array('id', 'value' => $income->id)); ?>

      <div class="box-body">
        <div class="form-group">
          <label for="name" class="col-xs-12 col-sm-3 control-label"><?php echo $this->l10n->_('ID'); ?></label>
          <div class="col-xs-12 col-sm-3">
            <?php echo $this->tag->textField(array('name', 'class' => 'form-control', 'disabled' => true, 'value' => $income->id)); ?>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-4">
            <?php echo $this->tag->textField(array('name', 'class' => 'form-control', 'value' => $income->name)); ?>
        ...
        <div class="form-group required">
          ...
          <div class="col-xs-12 col-sm-3">
            <?php echo $this->tag->select(array('member_id', $members, 'using' => array('id', 'name'), 'name' => 'member_id', 'class' => 'form-control show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'value' => $income->member_id)); ?>
        ...
        <div class="form-group required">
          ...
          <div class="col-xs-12 col-sm-3">
            <?php echo $this->tag->select(array('type_id', $types, 'using' => array('id', 'name'), 'name' => 'type_id', 'class' => 'form-control show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'value' => $income->type_id)); ?>
        ...
        <div class="form-group required">
          ...
          <div class="col-xs-12 col-sm-3">
            <div class="input-group">
              <?php echo $this->tag->textField(array('amount', 'class' => 'form-control', 'value' => $income->amount)); ?>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-3">
            <div class="input-group">
              <?php echo $this->tag->textField(array('exec_date', 'class' => 'form-control date-chooser', 'value' => date('Y-m-d H:i', strtotime($income->exec_date)))); ?>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            <?php echo $this->tag->textArea(array('remarks', 'class' => 'form-control', 'rows' => '3', 'value' => $income->remarks)); ?>
      ...
      <div class="box-footer">
        <div class="action-area">
          ...
          <?php echo $this->tag->linkTo(array('manager/incomes/index', $this->l10n->_('Cancel'), 'class' => 'btn btn-default')); ?>
