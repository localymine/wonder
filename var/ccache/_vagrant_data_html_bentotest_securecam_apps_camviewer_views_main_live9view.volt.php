...
<?php echo $this->flash->output(); ?>
      ...
      <div class="camview-root splitview">
          ...
          <div class="video-wrapper">
            <div id="video-container">
              ...
              <div class="mjpg-placeholder">
                <div class="fs-focused"></div>
                <div class="splitter-container split-9" data-split="9">
                  <div class="splitter-row">
                    <div class="splitter-col" data-slot="0"><?php echo $this->callMacro('customized_img', array('ident' => $identity, 'uid' => $user_id, 'type' => 2)); ?><span class="metainfo"><?php echo $this->l10n->_('Drag & drop thumbnail into this area'); ?></span></div>
                    <div class="splitter-col" data-slot="1"><?php echo $this->callMacro('customized_img', array('ident' => $identity, 'uid' => $user_id, 'type' => 2)); ?><span class="metainfo"><?php echo $this->l10n->_('Drag & drop thumbnail into this area'); ?></span></div>
                    <div class="splitter-col" data-slot="2"><?php echo $this->callMacro('customized_img', array('ident' => $identity, 'uid' => $user_id, 'type' => 2)); ?><span class="metainfo"><?php echo $this->l10n->_('Drag & drop thumbnail into this area'); ?></span></div>
                    <div class="divider"></div>
                  </div>
                  <div class="splitter-row">
                    <div class="splitter-col" data-slot="3"><?php echo $this->callMacro('customized_img', array('ident' => $identity, 'uid' => $user_id, 'type' => 2)); ?><span class="metainfo"><?php echo $this->l10n->_('Drag & drop thumbnail into this area'); ?></span></div>
                    <div class="splitter-col" data-slot="4"><?php echo $this->callMacro('customized_img', array('ident' => $identity, 'uid' => $user_id, 'type' => 2)); ?><span class="metainfo"><?php echo $this->l10n->_('Drag & drop thumbnail into this area'); ?></span></div>
                    <div class="splitter-col" data-slot="5"><?php echo $this->callMacro('customized_img', array('ident' => $identity, 'uid' => $user_id, 'type' => 2)); ?><span class="metainfo"><?php echo $this->l10n->_('Drag & drop thumbnail into this area'); ?></span></div>
                    <div class="divider"></div>
                  </div>
                  <div class="splitter-row">
                    <div class="splitter-col" data-slot="6"><?php echo $this->callMacro('customized_img', array('ident' => $identity, 'uid' => $user_id, 'type' => 2)); ?><span class="metainfo"><?php echo $this->l10n->_('Drag & drop thumbnail into this area'); ?></span></div>
                    <div class="splitter-col" data-slot="7"><?php echo $this->callMacro('customized_img', array('ident' => $identity, 'uid' => $user_id, 'type' => 2)); ?><span class="metainfo"><?php echo $this->l10n->_('Drag & drop thumbnail into this area'); ?></span></div>
                    <div class="splitter-col" data-slot="8"><?php echo $this->callMacro('customized_img', array('ident' => $identity, 'uid' => $user_id, 'type' => 2)); ?><span class="metainfo"><?php echo $this->l10n->_('Drag & drop thumbnail into this area'); ?></span></div>
                    <div class="divider"></div>
                  </div>
                </div>
                <div class="ptnav">
...
<?php if ($selectedcam->live == 1) { ?>
            <div class="thumbs" data-camera-type="<?php echo $selectedcam->type; ?>" data-camera-name="<?php echo $this->escaper->escapeHtml($selectedcam->name); ?>" data-camera-key="<?php echo $selectedcam->uniquekey; ?>" data-camera-liveurl="<?php echo (!(empty($selectedcam->liveurl)) ? '1' : '0'); ?>" data-ptz="<?php echo $selectedcam->ptz; ?>" data-has-agentbox="<?php echo ($selectedcam->agentbox_id > 0 ? '1' : '0'); ?>" data-rtsp="<?php echo ($selectedcam->type == 4 ? '1' : '0'); ?>">
    ...
    <div class="modal" id="camchooser" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <?php echo $this->tag->hiddenField(array('redirect_url', 'value' => 'live9view')); ?>
...
<?php echo $this->tag->javascriptInclude('js/splitxviewer.js'); ?>
