...
<?php echo $this->flash->output(); ?>
      ...
      <div class="box">
        ...
        <?php echo $this->tag->form(array('servicer/cameras/save/' . $camera->id, 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form')); ?>

        <?php echo $this->tag->hiddenField(array('user_id', 'value' => $camera->user_id)); ?>

        <?php echo $this->tag->hiddenField(array('id', 'value' => $camera->id)); ?>

        <?php echo $this->tag->hiddenField(array('member_id', 'value' => $camera->member_id)); ?>

        <?php echo $this->tag->hiddenField(array('group_id', 'value' => $camera->group_id)); ?>

        <div class="box-body">
          <div class="form-group required">
            <label for="course" class="col-xs-12 col-sm-3 control-label"><?php echo $this->l10n->_('Basic Course'); ?></label>
            <div class="col-xs-12 col-sm-3">
              <?php echo $this->tag->select(array('course', $courses, 'using' => array('value', 'name'), 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '', 'value' => $camera->course)); ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-xs-12 col-sm-2">
              <?php echo $this->tag->select(array('bitrate', $bitrates, 'using' => array('value', 'name'), 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '', 'value' => $camera->bitrate)); ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-xs-12 col-sm-2">
              <?php echo $this->tag->select(array('preserve', $preserves, 'using' => array('value', 'name'), 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '', 'value' => $camera->preserve)); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
              <span class="form-control"><?php echo $this->escaper->escapeHtml($camera->group->parent->parent->name); ?></span>
            </div>
          </div>
          <div class="form-group required">
            <label class="col-xs-12 col-sm-3 control-label"><?php echo $this->l10n->_('Area'); ?></label>
            <div class="col-xs-12 col-sm-8">
              <span class="form-control"><?php echo $this->escaper->escapeHtml($camera->group->parent->name); ?></span>
            </div>
          </div>
          <div class="form-group required">
            <label for="group_id" class="col-xs-12 col-sm-3 control-label"><?php echo $this->l10n->_('Endpoint'); ?></label>
            <div class="col-xs-12 col-sm-8">
              <span class="form-control"><?php echo $this->escaper->escapeHtml($camera->group->name); ?></span>
            </div>
          </div>
          <div class="form-group">
            <label for="agentbox_id" class="col-xs-12 col-sm-3 control-label"><?php echo $this->l10n->_('Agentbox Name'); ?></label>
            <div class="col-xs-12 col-sm-8">
              <?php echo $this->tag->select(array('agentbox_id', $agentboxes, 'using' => array('id', 'name'), 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '', 'value' => $camera->agentbox_id)); ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-xs-12 col-sm-8">
              <?php echo $this->tag->textField(array('uniquekey', 'class' => 'form-control', 'value' => $camera->uniquekey)); ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-xs-12 col-sm-8">
              <?php echo $this->tag->textField(array('name', 'class' => 'form-control', 'value' => $camera->name)); ?>
...
<?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4">
              <?php echo $this->tag->textField(array('ipaddr', 'class' => 'form-control', 'value' => $camera->ipaddr)); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4">
              <?php echo $this->tag->textField(array('netmask', 'class' => 'form-control', 'value' => $camera->netmask)); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4">
              <?php echo $this->tag->textField(array('gateway', 'class' => 'form-control', 'value' => $camera->gateway)); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4">
              <?php echo $this->tag->textField(array('dns1', 'class' => 'form-control', 'value' => $camera->dns1)); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4">
              <?php echo $this->tag->textField(array('dns2', 'class' => 'form-control', 'value' => $camera->dns2)); ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-xs-12 col-sm-4">
              <?php echo $this->tag->textField(array('hwaddr', 'class' => 'form-control', 'value' => $camera->hwaddr)); ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-xs-12 col-sm-4">
              <?php echo $this->tag->select(array('type', $cameratypes, 'using' => array('value', 'name'), 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '', 'value' => $camera->type)); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4">
              <?php echo $this->tag->textField(array('manufacturer', 'class' => 'form-control', 'value' => $camera->manufacturer)); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4">
              <?php echo $this->tag->textField(array('model', 'class' => 'form-control', 'value' => $camera->model)); ?>
...
<?php if ($camera->live == 1) { ?>
                  <?php echo $this->tag->checkField(array('live', 'name' => 'live', 'value' => 1, 'checked' => true)); ?> <?php echo $this->l10n->_('Available'); ?>

<?php } else { ?>
                  <?php echo $this->tag->checkField(array('live', 'name' => 'live', 'value' => 1)); ?> <?php echo $this->l10n->_('Available'); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
              <div class="checkbox-inline">
                <label for="ptz">
<?php if ($camera->ptz == 1) { ?>
                  <?php echo $this->tag->checkField(array('ptz', 'name' => 'ptz', 'value' => 1, 'checked' => true)); ?> <?php echo $this->l10n->_('Available'); ?>

<?php } else { ?>
                  <?php echo $this->tag->checkField(array('ptz', 'name' => 'ptz', 'value' => 1)); ?> <?php echo $this->l10n->_('Available'); ?>
...
<?php if ($camera->surveil == 1) { ?>
                  <?php echo $this->tag->checkField(array('surveil', 'name' => 'surveil', 'value' => 1, 'checked' => true)); ?> <?php echo $this->l10n->_('Surveil this Camera'); ?>

<?php } else { ?>
                  <?php echo $this->tag->checkField(array('surveil', 'name' => 'surveil', 'value' => 1)); ?> <?php echo $this->l10n->_('Surveil this Camera'); ?>
...
<?php } ?>
              ...
              <div>
                ...
                <?php if ($camera->surveil == 1) { ?>
                  <?php echo $this->tag->numericField(array('detect_interval', 'class' => 'form-control inline mins-box', 'min' => $detect_interval_default, 'max' => $detect_interval_default_max, 'value' => $camera->detect_interval)); ?>
                <?php } else { ?>
                  <?php echo $this->tag->numericField(array('detect_interval', 'class' => 'form-control inline mins-box', 'disabled' => 'disabled', 'min' => $detect_interval_default, 'max' => $detect_interval_default_max, 'value' => $camera->detect_interval)); ?>
                <?php } ?>
...
<?php if ($camera->disabled == 1) { ?>
                  <?php echo $this->tag->checkField(array('disabled', 'name' => 'disabled', 'value' => 1, 'checked' => true)); ?> <?php echo $this->l10n->_('Suspend'); ?>

<?php } else { ?>
                  <?php echo $this->tag->checkField(array('disabled', 'name' => 'disabled', 'value' => 1)); ?> <?php echo $this->l10n->_('Suspend'); ?>
...
<?php if ($camera->nocharged == 1) { ?>
                  <?php echo $this->tag->checkField(array('nocharged', 'name' => 'nocharged', 'value' => 1, 'checked' => true)); ?> <?php echo $this->l10n->_('Non-billable'); ?>

<?php } else { ?>
                  <?php echo $this->tag->checkField(array('nocharged', 'name' => 'nocharged', 'value' => 1)); ?> <?php echo $this->l10n->_('Non-billable'); ?>
...
<?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4">
              <div class="input-group">
                <?php echo $this->tag->textField(array('placed', 'name' => 'placed', 'class' => 'form-control', 'value' => $camera->placed)); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
							<?php echo $this->tag->select(array('promotion', $campaigns, 'using' => array('value', 'name'), 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '0', 'value' => $camera->promotion)); ?>
            </div>
          </div>
          <div class="form-group">
            <label for="remarks" class="col-xs-12 col-sm-3 control-label"><?php echo $this->l10n->_('Remarks'); ?></label>
            <div class="col-xs-12 col-sm-8">
              <?php echo $this->tag->textArea(array('remarks', 'class' => 'form-control', 'rows' => '3', 'value' => $camera->remarks)); ?>
