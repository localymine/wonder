...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><?php echo $this->l10n->_('Manage REC Accounts'); ?></h1>
      <ol class="breadcrumb">
        <li><?php echo $this->tag->linkTo(array('servicer/main/index', $this->l10n->_('<i class="fa fa-dashboard"></i> DashBoard'))); ?></li>
        <li><?php echo $this->tag->linkTo(array('servicer/recaccounts/index', $this->l10n->_('Manage REC Accounts'))); ?></li>
...
<?php echo $this->flash->output(); ?>
      ...
      <div class="box">
        ...
        <?php echo $this->tag->form(array('servicer/recaccounts/arrangement', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form')); ?>

        <div class="box-body">
          <div class="form-group">
            <label class="col-xs-12 col-sm-3 control-label"><?php echo $this->l10n->_('Specify Member:'); ?></label>
            <div class="col-xs-12 col-sm-8">
              <?php echo $this->tag->select(array('member_id', $members, 'using' => array('id', 'name'), 'class' => 'form-control selectpicker show-tick', 'data-live-search' => true, 'data-size' => 10, 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '')); ?>
