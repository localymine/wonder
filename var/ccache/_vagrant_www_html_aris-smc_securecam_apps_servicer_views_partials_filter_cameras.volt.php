        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><?= $this->l10n->__('Filter Cameras', 'Filter') ?></h4>
            </div>
            <div class="modal-body">
              <div class="bb-filter-abox form-horizontal row">
                ...
                <div class="col-xs-7 col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="status" class="col-xs-12 col-sm-4 control-label"><?= $this->l10n->_('Process status') ?></label>
                    <div class="col-xs-12 col-sm-8">
                  ...
                  <div class="form-group">
                    <label for="motion" class="col-xs-12 col-sm-4 control-label"><?= $this->l10n->_('Motion Detection') ?></label>
                    <div class="col-xs-12 col-sm-8">
                    <?= $this->tag->select(['motion', $motion_select, 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '']) ?>
