...
<?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
<?php if ($camera->promotion == 1) { ?>
              <div class="checkbox-inline">
                <label for="promotion">
                  <?= $this->tag->checkField(['promotion', 'name' => 'promotion', 'value' => 1, 'checked' => true]) ?> <?= $this->l10n->_('This camera is for promotion') ?>
...
<?php if ($camera->surveil == 1) { ?>
                    <?= $this->tag->checkField(['promo_nosurveil', 'name' => 'promo_nosurveil', 'value' => 1]) ?> <?= $this->l10n->_('Disable Surveil') ?>

<?php } else { ?>
                    <?= $this->tag->checkField(['promo_nosurveil', 'name' => 'promo_nosurveil', 'value' => 1, 'checked' => true]) ?> <?= $this->l10n->_('Disable Surveil') ?>
...
<?php } else { ?>
              <div class="checkbox-inline">
                <label for="promotion">
                  <?= $this->tag->checkField(['promotion', 'name' => 'promotion', 'value' => 1]) ?> <?= $this->l10n->_('This camera is for promotion') ?>
