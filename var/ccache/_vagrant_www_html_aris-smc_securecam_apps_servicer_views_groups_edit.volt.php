...
<?= $this->flash->output() ?>
      ...
      <div class="box">
        ...
        <?= $this->tag->form(['servicer/groups/save/' . $group->id, 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form']) ?>

        <?= $this->tag->hiddenField(['id', 'value' => $group->id]) ?>

        <?= $this->tag->hiddenField(['member_id', 'value' => $group->member_id]) ?>
...
<?php $this->partial('groups/edit-layer1', ['group' => $group]); ?>
<?php } ?>
<?php if ($group->layer == 2) { ?>
<?php $this->partial('groups/edit-layer2', ['group' => $group]); ?>
<?php } ?>
<?php if ($group->layer == 3) { ?>
<?php $this->partial('groups/edit-layer3', ['group' => $group]); ?>
<?php } ?>
        ...
        <div class="box-footer">
          <div class="action-area">
            ...
            <?= $this->tag->linkTo(['servicer/groups/arrangement/' . $group->member_id, $this->l10n->_('Cancel'), 'class' => 'btn btn-default']) ?>
