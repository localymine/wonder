...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><?php echo $this->tag->linkTo(array('manager/members/index', $this->l10n->_('Manage Members'))); ?></li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php echo $this->tag->form(array('manager/members/create', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form')); ?>
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            <?php echo $this->tag->textField(array('login', 'class' => 'form-control')); ?>
