...
<?php } ?>
              ...
              <div>
                ...
                <?php if ($recorder->disabled == 1) { ?>
                  <?= $this->tag->numericField(['detect_interval', 'class' => 'form-control inline mins-box', 'disabled' => 'disabled', 'min' => $detect_interval_default, 'max' => $detect_interval_default_max, 'value' => $recorder->detect_interval]) ?>
                <?php } else { ?>
                  <?= $this->tag->numericField(['detect_interval', 'class' => 'form-control inline mins-box', 'min' => $detect_interval_default, 'max' => $detect_interval_default_max, 'value' => $recorder->detect_interval]) ?>
                <?php } ?>
                <?= $this->l10n->_('mins') ?>
              </div>
            </div>
