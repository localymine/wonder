...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php echo $this->tag->form(array('manager/products/save', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>

      <?php echo $this->tag->hiddenField(array('product_id', 'value' => $product->id)); ?>
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-4">
            <div class="input-group">
              <?php echo $this->tag->textField(array('purchase_price', 'class' => 'form-control', 'value' => $product->purchase_price)); ?>
              <span class="input-group-addon">¥</span>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-2">
            <?php echo $this->tag->textField(array('unit', 'class' => 'form-control', 'value' => $product->unit)); ?>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-2">
            <?php echo $this->tag->textField(array('size', 'class' => 'form-control', 'value' => $product->size)); ?>
          </div>
        </div>
        ...
        <div class="form-group required">
          <label for="status" class="col-xs-12 col-sm-3 control-label"><?php echo $this->l10n->_('Type'); ?></label>
          <div class="col-xs-12 col-sm-3">
            <?php echo $this->tag->select(array('category_id', $categories, 'using' => array('id', 'name'), 'name' => 'category_id', 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '', 'value' => $product->category_id)); ?>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8">
            <?php echo $this->tag->textArea(array('remarks', 'class' => 'form-control', 'rows' => '3', 'value' => $product->remarks)); ?>
