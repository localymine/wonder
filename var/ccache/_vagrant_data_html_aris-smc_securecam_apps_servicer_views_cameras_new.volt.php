...
<?php } ?>
            ...
            <div class="col-xs-12 col-sm-8">
              ...
              <div>
                ...
                <?php if (isset($psurveil)) { ?>
                  <?= $this->tag->numericField(['detect_interval', 'class' => 'form-control inline mins-box', 'min' => $detect_interval_default, 'max' => $detect_interval_default_max]) ?>
                <?php } else { ?>
                  <?= $this->tag->numericField(['detect_interval', 'class' => 'form-control inline mins-box', 'disabled' => 'disabled', 'min' => $detect_interval_default, 'max' => $detect_interval_default_max]) ?>
                <?php } ?>
                <?= $this->l10n->_('mins') ?>
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
							<?= $this->tag->select(['promotion', $campaigns, 'using' => ['value', 'name'], 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '0']) ?>
            </div>
          </div>
          <div class="form-group">
