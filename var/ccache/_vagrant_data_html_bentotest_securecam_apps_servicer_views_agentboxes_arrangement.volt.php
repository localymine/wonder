      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="hidden-xs col-sm-3 group-header-pad">
            ...
            <div class="hidden-xs col-sm-3 group-header-pad">
              <h4><?php echo $this->l10n->_('Agentboxes'); ?></h4>
            </div>
          </div>
          <div class="row">
...
<?php if (isset($layer1)) { ?>
              <div class="input-group input-group-sm input-group-fake group-header-pad">
                ...
                <span class="input-group-btn">
                  <?php echo $this->tag->linkTo(array('servicer/groups/show/' . $layer1->id, '<span class="fa fa-eye"></span>', 'class' => 'btn btn-default')); ?>

                </span>
              </div>
<?php } else { ?>
              <?php echo $this->tag->linkTo(array('servicer/groups/new/1/' . $member->id, $this->l10n->_('New Group root'), 'class' => 'btn btn-primary btn-md btn-block')); ?>

<?php } ?>
            </div>
            <div class="col-xs-12 col-sm-9">
<?php if (isset($layer2)) { ?>
<?php $this->partial('agentboxes/arrangement-layer2', array('layer2' => $layer2, 'layer3' => $layer3)); ?>
<?php } ?>
            </div>
          </div>
        </div>
