            ...
            <div class="modal-body">
              <div class="bb-filter-abox form-horizontal row">
                ...
                <div class="col-xs-7 col-sm-7">
                  <div class="form-group">
                    <label for="name" class="col-xs-12 col-sm-4 control-label"><?= $this->l10n->_('Related Agent') ?></label>
                    <div class="col-xs-12 col-sm-8">
                  ...
                  <div class="form-group">
                    <label for="status" class="col-xs-12 col-sm-4 control-label"><?= $this->l10n->_('Connection status') ?></label>
                    <div class="col-xs-12 col-sm-8">
                    <?= $this->tag->selectStatic(['status', $stat_label, 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '']) ?>

                    </div>
                  </div>
                  <div class="form-group">
                    <label for="memtype" class="col-xs-12 col-sm-4 control-label"><?= $this->l10n->_('External Memory') ?></label>
                    <div class="col-xs-12 col-sm-8">
                    <?= $this->tag->selectStatic(['memtype', $memtype_label, 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '']) ?>

                    </div>
                  </div>
                  <div class="form-group">
                    <label for="firmver" class="col-xs-12 col-sm-4 control-label"><?= $this->l10n->_('Firmware Version') ?></label>
                    <div class="col-xs-12 col-sm-8">
                    <?= $this->tag->textField(['firmver', 'class' => 'form-control', 'placeholder' => $this->l10n->__('Enter Firmware version', 'Filter')]) ?>
