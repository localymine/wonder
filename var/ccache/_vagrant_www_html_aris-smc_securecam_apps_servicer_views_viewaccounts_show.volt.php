...
<?php } ?>
          <tr>
          <th><?= $this->l10n->_('VIEW Account Login') ?></th>
          <td><?= $this->escaper->escapeHtml($group->login) ?></td>
          </tr>
          <tr>
          <th><?= $this->l10n->_('VIEW Account Password') ?></th>
          <td><?= $this->escaper->escapeHtml($group->passwd) ?></td>
          </tr>
          <tr>
          <th><?= $this->l10n->_('Download') ?></th>
          <td><?= ($group->downloadable == 1 ? $this->l10n->_('Enabled') : $this->l10n->_('Disabled')) ?></td>
          </tr>
          <tr>
        ...
        <div class="box-footer">
          <div class="action-area">
            <?= $this->tag->linkTo(['servicer/viewaccounts/edit/' . $group->id, $this->l10n->_('<i class="fa fa-pencil"></i> Edit'), 'class' => 'btn btn-success pull-left']) ?>

            <?= $this->tag->linkTo(['servicer/viewaccounts/arrangement/' . $group->member_id, $this->l10n->_('Cancel'), 'class' => 'btn btn-default pull-left']) ?>
