...
<?php if ($group->layer == 3) { ?>
                ...
                <li><?= $this->tag->linkTo(['servicer/network/show/' . $group->id, $this->l10n->_('Network Information')]) ?></li>
                <li><?= $this->tag->linkTo(['servicer/network/search/' . $group->id, $this->l10n->_('Search for Network')]) ?></li>
<?php } ?>
              </ul>
          </div>
        </div>
