...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><?php echo $this->l10n->__('Manage Clients', 'client'); ?></h1>
    <ol class="breadcrumb">
      <li><?php echo $this->tag->linkTo(array('manager/main/index', $this->l10n->_('<i class="fa fa-dashboard"></i> DashBoard'))); ?></li>
      <li><?php echo $this->tag->linkTo(array('manager/clients/index', $this->l10n->__('Manage Clients', 'client'))); ?></li>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <?php echo $this->tag->linkTo(array('manager/clients/new/', $this->l10n->_('<i class="fa fa-file"></i><span>New</span>'), 'class' => 'btn btn-primary btn-sm xcenter')); ?>

      </div>
      <div class="box-body" data-csrftoken="<?php echo $this->security->getToken(); ?>">

        <?php echo $this->partial('partials/paginator/clients'); ?>
