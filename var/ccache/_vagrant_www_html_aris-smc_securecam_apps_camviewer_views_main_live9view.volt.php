              ...
              <div class="mjpg-placeholder">
                ...
                <div class="splitter-container split-9" data-split="9">
                  <div class="splitter-row">
                    <div class="splitter-col" data-slot="0"><img src="<?= $this->url->get('img/blank.png') ?>"><span class="metainfo"><?= $this->l10n->_('Drag & drop thumbnail into this area') ?></span></div>
                    <div class="splitter-col" data-slot="1"><img src="<?= $this->url->get('img/blank.png') ?>"><span class="metainfo"><?= $this->l10n->_('Drag & drop thumbnail into this area') ?></span></div>
                    <div class="splitter-col" data-slot="2"><img src="<?= $this->url->get('img/blank.png') ?>"><span class="metainfo"><?= $this->l10n->_('Drag & drop thumbnail into this area') ?></span></div>
                    <div class="divider"></div>
                  </div>
                  <div class="splitter-row">
                    <div class="splitter-col" data-slot="3"><img src="<?= $this->url->get('img/blank.png') ?>"><span class="metainfo"><?= $this->l10n->_('Drag & drop thumbnail into this area') ?></span></div>
                    <div class="splitter-col" data-slot="4"><img src="<?= $this->url->get('img/blank.png') ?>"><span class="metainfo"><?= $this->l10n->_('Drag & drop thumbnail into this area') ?></span></div>
                    <div class="splitter-col" data-slot="5"><img src="<?= $this->url->get('img/blank.png') ?>"><span class="metainfo"><?= $this->l10n->_('Drag & drop thumbnail into this area') ?></span></div>
                    <div class="divider"></div>
                  </div>
                  <div class="splitter-row">
                    <div class="splitter-col" data-slot="6"><img src="<?= $this->url->get('img/blank.png') ?>"><span class="metainfo"><?= $this->l10n->_('Drag & drop thumbnail into this area') ?></span></div>
                    <div class="splitter-col" data-slot="7"><img src="<?= $this->url->get('img/blank.png') ?>"><span class="metainfo"><?= $this->l10n->_('Drag & drop thumbnail into this area') ?></span></div>
                    <div class="splitter-col" data-slot="8"><img src="<?= $this->url->get('img/blank.png') ?>"><span class="metainfo"><?= $this->l10n->_('Drag & drop thumbnail into this area') ?></span></div>
                    <div class="divider"></div>
                  </div>
                </div>
                <div class="ptnav">
...
<?php if ($selectedcam->live == 1) { ?>
            <div class="thumbs" data-camera-type="<?= $selectedcam->type ?>" data-camera-name="<?= $this->escaper->escapeHtml($selectedcam->name) ?>" data-camera-key="<?= $selectedcam->uniquekey ?>" data-camera-liveurl="<?= (!(empty($selectedcam->liveurl)) ? '1' : '0') ?>" data-ptz="<?= $selectedcam->ptz ?>" data-has-agentbox="<?= ($selectedcam->agentbox_id > 0 ? '1' : '0') ?>">
    ...
    <div class="modal" id="camchooser" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <?= $this->tag->hiddenField(['redirect_url', 'value' => 'live9view']) ?>
...
<?= $this->tag->javascriptInclude('js/splitxviewer.js') ?>
