...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><?= $this->l10n->_('Vendor Options') ?></h1>
      <ol class="breadcrumb">
        <li><?= $this->tag->linkTo(['servicer/main/index', $this->l10n->_('<i class="fa fa-dashboard"></i> DashBoard')]) ?></li>
        <li><?= $this->tag->linkTo(['servicer/vendoroptions/index', $this->l10n->_('Vendor Options')]) ?></li>
...
<?= $this->flash->output() ?>
      ...
      <div class="box">
        ...
        <?= $this->tag->form(['servicer/vendoroptions/show', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form']) ?>

        <div class="box-body">
          <div class="form-group">
            <label class="col-xs-12 col-sm-3 control-label"><?= $this->l10n->_('Specify Member:') ?></label>
            <div class="col-xs-12 col-sm-8">
              <?= $this->tag->select(['member_id', $members, 'using' => ['id', 'name'], 'class' => 'form-control selectpicker show-tick', 'data-style' => 'btn-white', 'data-live-search' => true, 'data-size' => 10, 'useEmpty' => true, 'emptyText' => $this->l10n->_('Choose...'), 'emptyValue' => '']) ?>
        ...
        <div class="box-footer">
          <div class="action-area">
            <?= $this->tag->submitButton([$this->l10n->_('Select'), 'class' => 'btn btn-info']) ?>
